    ...
    match instr {
        ...
        Instr::BinOp { op, dst, lhs, rhs } => {
            match op {
                ...
                // Claim 4s: guard added after each instruction — sxtw/cmp/b.ne.
                ...
                // negatives for u32 wrap. Test suite exercises i32; documented in
                // fls-ambiguities.md. Cache-line: four 4-byte instructions per op.
                IrBinOp::Add => {
