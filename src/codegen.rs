    ...
    match instr {
        ...
        Instr::BinOp { op, dst, lhs, rhs } => {
            match op {
                ...
                // After the primary instruction, check whether the 64-bit result
                // equals its own sign-extended 32-bit self. If not, the result
                ...
                // [i32::MAX+1, u32::MAX]. Test suite exercises i32 only.
                // x9 is caller-saved scratch (same register used by MIN/-1 guard).
                IrBinOp::Add => {
