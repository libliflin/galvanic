        ...
        Instr::BinOp { op, dst, lhs, rhs } => {
            match op {
                ...
                IrBinOp::Add => {
                    ...
                    // FLS §6.23: AMBIGUOUS — guard calibrated to i32 semantics; false-positive
                    // for i64 values outside i32 range; false-negative for u32 wrap. See fls-ambiguities.md.
